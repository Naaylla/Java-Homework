...
import DBAINTERVENTION.DBAINTERVENTIONFrame2;

public class EmployesDBATasks extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EmployesDBATasks frame = new EmployesDBATasks();
